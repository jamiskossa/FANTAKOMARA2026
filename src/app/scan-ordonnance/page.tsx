      ...
      <main className="flex-grow">
        <section className="py-20 bg-fluid-gradient border-b">
          <div className="container mx-auto px-4 text-center max-w-3xl">
            ...
            <h1 className="text-5xl lg:text-7xl font-black mb-6 text-slate-900 uppercase tracking-tighter">Scan Ordonnance</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <Card 
              className={`border-4 border-dashed p-12 text-center rounded-[48px] bg-white shadow-soft transition-all cursor-pointer ${
                ...
                {isAnalyzing ? (
                  <div className="flex flex-col items-center gap-6 animate-pulse">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-3xl font-black text-primary uppercase tracking-tight">Analyse IA en cours...</h3>
                      <p className="text-slate-400 font-bold uppercase text-[10px] tracking-widest">Lecture des médicaments et dosages</p>
                    </div>
                  </div>
                ) : (
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 font-bold uppercase text-[10px] tracking-widest">Formats acceptés : PHOTO, PDF • Max 5Mo</p>
                    </div>
                    <Button 
                      className="rounded-full px-12 h-14 bg-secondary hover:bg-secondary/90 shadow-xl shadow-secondary/20 text-white font-black uppercase tracking-widest"
                    >
            ...
            <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="flex items-start gap-6 p-8 bg-white rounded-[32px] shadow-soft border border-slate-100">
                <div className="w-14 h-14 bg-primary/10 rounded-2xl flex items-center justify-center shrink-0 text-primary">
                  <ShieldCheck className="w-8 h-8" />
                </div>
                <div>
                  <h4 className="font-black text-slate-900 uppercase tracking-tighter mb-2">Données de Santé</h4>
                  <p className="text-sm text-slate-500 font-medium leading-relaxed">Vos ordonnances sont traitées selon les normes HDS et supprimées après préparation.</p>
                </div>
              </div>
              <div className="flex items-start gap-6 p-8 bg-white rounded-[32px] shadow-soft border border-slate-100">
                ...
                <div>
                  <h4 className="font-black text-slate-900 uppercase tracking-tighter mb-2">Analyse Immédiate</h4>
                  <p className="text-sm text-slate-500 font-medium leading-relaxed">Notre IA identifie les produits en quelques secondes pour faire gagner du temps au pharmacien.</p>
                </div>
              </div>
            </div>
          </div>
