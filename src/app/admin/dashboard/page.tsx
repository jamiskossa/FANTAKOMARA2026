              ...
              <Table>
                <TableHeader className="bg-slate-50">
                  <TableRow>
                    ...
                    <TableHead className="uppercase text-[9px] font-black">Message</TableHead>
                    ...
                    <TableRow key={m.id} className={`hover:bg-slate-50/50 ${!m.isReplied ? 'bg-primary/5' : ''}`}>
                      <TableCell className="pl-6 py-3">
                        <div className="flex flex-col">
                          ...
                          <span className="text-[8px] text-slate-300 uppercase mt-1">
                            {m.submissionDate?.seconds ? new Date(m.submissionDate.seconds * 1000).toLocaleDateString() : '...'}
                          </span>
                        </div>
                      </TableCell>
                      <TableCell className="py-3">
                        <p className="text-[11px] text-slate-600 line-clamp-2 max-w-md">{m.messageContent}</p>
                      </TableCell>
